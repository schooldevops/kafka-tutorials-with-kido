...
public class ProducerController {
    ...
    @Value("${kafka.manual-ack-topic}")
    public String TOPIC_MANUAL_ACK;
    ...
    @PostMapping("manual-produce")
    public ResponseEntity<?> produceManual(@RequestBody TestEntity testEntity) {
        testEntity.setTime(LocalDateTime.now());

        ListenableFuture<SendResult<String, Object>> future = kafkaProducerTemplate.send(TOPIC_MANUAL_ACK, testEntity);
